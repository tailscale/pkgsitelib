...
func TestVersionedPkgPath(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			pkgPath: "github.com/tailscale/pkgsitelib/pkg/log",
			modInfo: &ModuleInfo{
				ModulePath:      "github.com/tailscale/pkgsitelib",
				ResolvedVersion: "v1.1.2",
				ModulePackages:  map[string]bool{"github.com/tailscale/pkgsitelib/pkg/log": true},
			},
			want: "github.com/tailscale/pkgsitelib@v1.1.2/pkg/log",
		},
		{
			...
			want: "github.com/tailscale/pkgsitelib@v0.0.0-20200709011933-a59b4ce778c4/pkg/log",
		},
		{
